...
/*!***********************!*\
  !*** ./datasource.ts ***!
  \***********************/
/*! exports provided: TimeLionDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeLionDataSource", function() { return TimeLionDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var xregexp__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! xregexp */ "../node_modules/xregexp/lib/index.js");
/* harmony import */ var xregexp__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(xregexp__WEBPACK_IMPORTED_MODULE_4__);
...
var TimeLionDataSource =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(TimeLionDataSource, _super);

  function TimeLionDataSource(instanceSettings) {
  ...
  TimeLionDataSource.prototype.timelionPost = function (data) {
    var options = {
      url: this.url + '/run',
      method: 'POST',
      data: data
  ...
  TimeLionDataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            queries = options.targets.filter(function (tgt) {
              return tgt.queryText !== _types__WEBPACK_IMPORTED_MODULE_3__["defaultQuery"].queryText && !tgt.hide;
            }).map(function (t) {
              return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_2__["getTemplateSrv"])().replace(t.queryText, options.scopedVars, 'lucene');
            }).map(function (str) {
              return _this.divideTimeLionQueries(str);
          ...
          case 1:
            ...
            /*return*/
            , {
              data: responses.map(function (rsp) {
                return rsp.data.sheet.map(function (sheet) {
                  return sheet.list;
                }).reduce(function (acc, cur) {
                  return acc.concat(cur);
                }, []).map(function (list) {
                  return {
                    target: list.label,
                    datapoints: list.data.map(function (d) {
                      return [d[1], d[0]];
                    })
                  };
                });
  ...
  TimeLionDataSource.prototype.divideTimeLionQueries = function (str) {
    // (?                # Timelion operation
    //   \.\w+             # Starts with .word
    //     \(                # Argument list
    ...
    // )+
    var regex = /(?:\.\w+\((?:\((?:\((?:\(.*?\)|".*?"|.*?)*?\)|".*?"|.*?)*?\)|".*?"|.*?)*?\))+/g;
    return xregexp__WEBPACK_IMPORTED_MODULE_4___default.a.match(str, regex, 'all');
  };

  TimeLionDataSource.prototype.interpolateVariablesInQueries = function (queries, scopedVars) {
    var _this = this;
    ...
    return queries.map(function (query) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        ...
        query: Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_2__["getTemplateSrv"])().replace(query.queryText, scopedVars, 'lucene')
      });
    });
  };

  TimeLionDataSource.prototype.testDatasource = function () {
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_1__["TimeLionDataSource"]).setConfigEditor(_ConfigEditor__WEBPACK_IMPORTED_MODULE_2__["ConfigEditor"]).setQueryEditor(_QueryEditor__WEBPACK_IMPORTED_MODULE_3__["QueryEditor"]);
